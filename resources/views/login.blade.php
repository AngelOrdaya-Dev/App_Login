    ...
    <style>
        ...
        *::after {
        ...
        .btn-github:hover {
            ...
            box-shadow: 0 20px 40px rgba(36, 41, 46, 0.3);
        }
...
<body>
    <div class="card">
        <div class="card-header">
            <div
                style="background-color: #ff0000; color: #fff; width: 70px; height: 70px; display: flex; align-items: center; justify-content: center; border-radius: 20px; margin: 0 auto 1.5rem; box-shadow: 0 0 25px rgba(255, 0, 0, 0.5); border: 1px solid rgba(255,255,255,0.1);">
        ...
        @if($errors->any())
            <div
                style="background: rgba(255, 62, 62, 0.15); border: 1px solid #ff3e3e; border-radius: 12px; padding: 1rem; color: #ff3e3e; font-size: 0.9rem; margin-bottom: 2rem; font-weight: 600; text-align: center;">
        ...
        @if(session('error'))
            <div
                style="background: #ff0000; border-radius: 8px; padding: 1rem; color: #fff; font-size: 0.95rem; margin-bottom: 2rem; font-weight: 700; text-align: center;">
                {{ session('error') }}</div>
        @endif
